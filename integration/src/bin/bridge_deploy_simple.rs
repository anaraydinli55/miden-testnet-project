...
async fn main() -> Result<()> {
    ...
    println!("   (This may take 2-5 minutes for first sync...)");
    
    let ClientSetup { mut client, .. } = setup_client().await?;
    
    println!("✅ Client ready, syncing state...");
    ...
    println!("🔨 Creating bridge account...");
    ...
    println!("   SAVE THIS ID! Add it to your .env as BRIDGE_ACCOUNT_ID");
